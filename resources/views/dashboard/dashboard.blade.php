                    ...
                    <div class="row">
                      <div class="col-md-12">
                        ...
                        <div class="form-group">
                              ...
                              <option value="" selected disabled>Select Nature of Activity</option>
   ...
   <!-- Add Participant Modal -->
    <div class="modal fade" id="add-participant-modal" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          <div class="modal-header">
            <h5 class="modal-title" id="exampleModalLongTitle">Add Event Participant</h5>
            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
              <span aria-hidden="true">&times;</span>
            </button>
          </div>
    ...
    <div class="modal fade" id="add-speaker-modal" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          <div class="modal-header">
            <h5 class="modal-title" id="exampleModalLongTitle">Add Event Speaker</h5>
            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
              <span aria-hidden="true">&times;</span>
            </button>
          </div>
        ...
        { data: null,
          render: function ( data, type, row ) { 
            ...
            if (data.status == 1) {
              ...
              status_name = "<span class='badge badge-danger'>For Completion</span>";
            }
